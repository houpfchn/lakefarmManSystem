...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Js_Login.js"></script>
	<STYLE type=text/css>
		BODY {
			TEXT-ALIGN: center;
			PADDING-BOTTOM: 0px;
...
<FORM id=adminlogin  method=post
	  name=adminlogin action="${pageContext.request.contextPath}/lakefarm/manager/managerLogin.do"  >
	<DIV></DIV>
						...
						<DIV
							...
							<DIV
								...
								<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
									<TBODY>
									<TR>
										<TD style="HEIGHT: 45px"><INPUT type="text" class=input value="${manager.man_managername }" name="man_managername" id="man_managername"></TD>
									</TR>
									<TR>
										<TD><INPUT type="password" class=input value="${manager.man_password }" name="man_password" id="man_password"/></TD>
									</TR>
									<TR>
										<td>
											<select id="man_identity" name="man_identity" class="input" style="margin-top: 15px;height: 24px">
												<option value="">请选择用户类型...</option>
												<option value="1"  ${'1'==manager.man_identity?'selected':'' }>系统管理员</option>
												<option value="2"  ${'2'==manager.man_identity?'selected':'' }>销售主管</option>
